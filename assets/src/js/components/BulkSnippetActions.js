...
export function BulkSnippetActions({
	...
	return (
		<div className="updatescontrol-actions">
			<div className="updatescontrol-actions-bulk">
				<Button
					variant="tertiary"
					onClick={onEnableAll}
					__next40pxDefaultSize
				>
					{__('Enable all actions', 'updatescontrol')}
				</Button>
				<Button
					isDestructive
					...
					__next40pxDefaultSize
				>
					{__('Disable all actions', 'updatescontrol')}
				</Button>
			</div>
