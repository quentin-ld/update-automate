 ...
 * Keys must match window.updatescontrolIntegrationsActive.
 */
export const INTEGRATIONS_AUTOCONFIG = [
	{
		key: 'autoptimize',
		path: '/updatescontrol/v1/autoconfig/autoptimize',
		successMessage: __(
			'Autoptimize has been configured.',
			'updatescontrol'
		),
		errorMessage: __(
		...
		buttonLabel: __('Setup Autoptimize', 'updatescontrol'),
		helpText: __(
	...
	{
		key: 'cache_enabler',
		path: '/updatescontrol/v1/autoconfig/cache-enabler',
		successMessage: __(
			'Cache Enabler has been configured.',
			'updatescontrol'
		),
		errorMessage: __(
		...
		buttonLabel: __('Setup Cache Enabler', 'updatescontrol'),
		helpText: __(
	...
	},
	{
		...
		path: '/updatescontrol/v1/autoconfig/sqlite-object-cache',
		successMessage: __(
		...
		buttonLabel: __('Setup SQLite Object Cache', 'updatescontrol'),
		helpText: __(
